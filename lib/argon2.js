...
const resource = externalResources.add( `softvisio-node/argon2/resources/napi-v3-${process.platform}-${process.arch}.node`, { "location": "lib/binaries", "resolve": __filename } );
